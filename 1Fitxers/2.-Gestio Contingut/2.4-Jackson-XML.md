...
>**Important** 
Recorda que has d'afegir les dependències de Jackson XML al teu fitxer `pom.xml` per utilitzar aquesta funcionalitat.
En este cas, necessites afegir la següent dependència:
